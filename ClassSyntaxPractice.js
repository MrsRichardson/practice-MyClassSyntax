...
const MyComputer= new Computer('Dell','Windows','Laptop');

// MyComputer.powerOn();

const DanisComputer= new Computer('Apple','Mac','Laptop');

//DanisComputer.powerOn();

//Computer.turnEmOn([MyComputer,DanisComputer]);
